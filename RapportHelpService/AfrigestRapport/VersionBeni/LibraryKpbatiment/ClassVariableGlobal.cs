...
namespace LibraryKpbatiment
{
    public class ClassVariableGlobal
    {
        ...
        public static string seteconnexion()
        {
            ...
            // KPSHOP BENI
            //seteconnexionLoc = "Data Source=KP-SHOP-SERVER;Initial Catalog=BaseKpShop;User Id=KP;Password=12345678";
            // -- ANCIEN KPSHOP BUNIA A KPSHOP BENI 
            //seteconnexionLoc = "Data Source=KP-SHOP-SERVER;Initial Catalog=BaseAncienBunia;User Id=KP;Password=12345678";
            ...
            seteconnexionLoc = @"Data Source=AFRISOFT;Initial Catalog=Kp_ShopDB;Integrated Security=false ;User ID=Yan; Password ='123456789'";
            //seteconnexionLoc = @"Data Source=KP-SHOP-SERVER;Initial Catalog=BaseKpShop2022;Integrated Security=false ;User ID=KP; Password ='12345678'";
